    ...
    <div className=" text-white md:px-0 bg-repeat bg-grid-wave min-h-screen bg-contain font-nohemi">
      <div className=" md:px-10 md:pb-20 pb-5">
        ...
        <div className="md:mx-20 mx-7 md:mt-16 mt-10 flex flex-col md:gap-3 gap-2">
          <div className="leading-[25px] flex md:text-6xl md:font-medium md:tracking-normal text-xl font-light tracking-wider">
            <p>Experience</p>
          </div>
        </div>

        {/* DESKTOP */}
        <div className="hidden relative md:grid grid-cols-[4fr_1fr_4fr] min-h-64 mx-20 py-10">
          <motion.div
            initial={{ height: 0 }}
            animate={{ height: "100%" }}
            transition={{ duration: 3, ease: "easeInOut" }}
            className="absolute h-full w-1 rounded-full opacity-40 bg-white md:left-0 md:right-0 -left-12 mx-auto"
          ></motion.div>
              ...
              <React.Fragment key={index}>
                {index % 2 === 0 ? (
                  <>
                    ...
                    >
                      <motion.div className=" relative overflow-hidden rounded-xl bg-gradient-to-tl from-white/40 to-[#cecece]/10 blur-bg-sm">
                        <motion.div
                          ...
                          className="absolute h-full w-full bg-black inset-0 z-50"
                        ></motion.div>
                        {item.image === "ncu.svg" && (
                          <Image
                        ...
                        {item.image === "pubg.svg" && (
                          <Image
                            className="absolute -right-0 -bottom-5 opacity-25"
                            src={item.image}
                            width={300}
                            height={500}
                            alt="ncu"
                        ...
                        <div className="flex relative z-20 flex-col justify-center md:px-10 md:py-16 p-5 rounded-xl ">
                          <p className="font-light tracking-wide md:text-2xl">
                            {item.position}
                          </p>
                          <p className=" md:text-[2.5em]">{item.role}</p>
                      ...
                      </motion.div>
                      {
                        <motion.div
                          ...
                          className="absolute top-0 bottom-0 my-auto h-fit px-8 py-5"
                        >
                          Work Description <br />
                    ...
                    >
                      {item.year} <br />{" "}
                      <span className=" bg-white p-1 rounded-md text-black font-medium md:text-xl">
                        {" "}
                        {item.duration}
                      </span>
                    </motion.div>
                  ...
                  <>
                    <motion.div
                      ...
                      custom={index}
                      className=" self-center justify-self-end md:text-2xl"
                    >
                      {item.year} <br />{" "}
                      <span className=" bg-white p-1 rounded-md text-black font-medium md:text-xl">
                        {" "}
                    ...
                    >
                      <motion.div className=" relative overflow-hidden rounded-xl bg-gradient-to-tl from-white/40 to-[#cecece]/10 blur-bg-sm">
                        ...
                        {item.image === "cu.svg" && (
                          <Image
                            className="absolute right-5 -bottom-5 opacity-25"
                            src={item.image}
                            width={180}
                            height={500}
                            alt="ncu"
                        ...
                        {item.image === "raj.svg" && (
                          <Image
                            className="absolute -right-16 -bottom-10 opacity-20"
                            src={item.image}
                            width={400}
                            height={500}
                            alt="ncu"
                        ...
                        <div className="flex relative z-20 flex-col justify-center px-10 py-16 rounded-xl ">
                          ...
                          <p className=" text-[2.5em] leading-10 py-3">
                            {item.role}
                          </p>
                          <div className="flex gap-3 pb-2">
                            <div className="w-5 h-5 pt-[2px]">
        ...
        {/* MOBILE  */}
        <div className="md:hidden relative flex flex-col gap-5 min-h-64 mx-12 pb-10 pt-5">
          <motion.div
            initial={{ height: 0 }}
            animate={{ height: "95%" }}
            transition={{ duration: 3, ease: "easeInOut" }}
            className="absolute h-full w-1 rounded-full opacity-40 bg-white md:left-0 md:right-0 -left-5 mx-auto"
          ></motion.div>
          {expData.map((item, index) => {
            const Icon = icons[item.icon];
            return (
                ...
                <>
                  ...
                  >
                    <motion.div className=" relative overflow-hidden rounded-xl bg-gradient-to-tl from-white/40 to-[#cecece]/10 blur-bg-sm">
                      ...
                      {item.image === "gold.svg" && (
                        <Image
                          className="absolute -right-0 -bottom-4 opacity-20"
                          src={item.image}
                          width={150}
                          height={500}
                          alt="ncu"
                      ...
                      {item.image === "cu.svg" && (
                        <Image
                          className="absolute right-1 -bottom-2 opacity-15"
                          src={item.image}
                          width={80}
                          height={500}
                          alt="ncu"
                      ...
                      <div className="flex gap-2 items-center justify-start pl-3 pt-3">
                        <motion.div
                          // variants={fadeInAnimationVariants}
                          initial="initial"
                          whileInView="animate"
                        ...
                        >
                          <Icon size={20} color="black" opacity={0.8} />
                        </motion.div>
                        ...
                        //   variants={fadeInAnimationVariants}
                          ...
                          custom={index}
                          className=" self-center md:text-2xl text-sm"
                        >
                          {item.year} <br />{" "}
                          <span className=" bg-white p-1 rounded-md text-black font-medium md:text-xl">
                            {" "}
                  ...
                  {/* <motion.div
                                        ...
                                        <motion.div
                                            ...
                                            className=' self-center md:text-2xl'
                                        >
                                            {item.year} <br /> <span className=' bg-white p-1 rounded-md text-black font-medium md:text-xl'> {item.duration}</span>
                                        </motion.div> */}
                </>
              </React.Fragment>
            );
